...
- **No figures.** The project plan calls figures mandatory in the exec summary, with the primary-contrast table as one of them. This document has none - real content to add once it moves into whatever format carries the actual submission, not a markdown limitation.
